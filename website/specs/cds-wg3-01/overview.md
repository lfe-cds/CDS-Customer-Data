...
meta_description: Linux Foundation Energy - Connected Data Specifications (CDS) - Customer Data Working Group (WG3) - Specifications - CDS-WG3-01 - Customer Data - Overview
---
...
To help streamline adoption, this specification has pre-written [Scenarios]({{ "/specs/cds-wg3-01/latest" | relative_url }}#scenarios), which are ready-made sets of requirements that can be implemented by utilities or mandated by regulators to meet common use cases.
...
This specification extends the CDS Registration Working Group (CDS-WG1) [specifications](https://cds-registration.lfenergy.org/specs/) by defining new [Scopes]({{ "/specs/cds-wg3-01/latest" | relative_url }}#scopes) (i.e. permission levels) that Servers can offer for granular customer data access.
...
This specification also defines [Customer Data APIs]({{ "/specs/cds-wg3-01/latest" | relative_url }}#api) (Application Programming Interfaces) that organize customer data into documented API endpoints and machine-readable data formats.
...
Another part of the extension is a set of [APIs]({{ "/specs/cds-wg3-01/latest" | relative_url }}#api) and data formats for customer data (listed below).

* Customer account and meter details:
    * [Accounts API]({{ "/specs/cds-wg3-01/latest" | relative_url }}#accounts-api) - Standardizes details about customer billing accounts (e.g. the number at the top of your utility bill).
    * [Service Contracts API]({{ "/specs/cds-wg3-01/latest" | relative_url }}#service-contracts-api) - Standardizes details about customer service contracts (e.g. your individual electric or gas service).
    * [Service Points API]({{ "/specs/cds-wg3-01/latest" | relative_url }}#service-points-api) - Standardizes details about utility service point locations (e.g. the box on the side of your home).
    * [Meter Devices API]({{ "/specs/cds-wg3-01/latest" | relative_url }}#meter-devices-api) - Standardizes details about utility meter devices (e.g. the physical meter reading your usage).
* Customer bill data:
    * [Bill Statements API]({{ "/specs/cds-wg3-01/latest" | relative_url }}#bill-statements-api) - Standardizes details about a customer's bill statement (how much you owe, payment due dates, etc.).
    * [Bill Sections API]({{ "/specs/cds-wg3-01/latest" | relative_url }}#bill-sections-api) - Standardizes usage and cost breakdowns for each of a customer's service contracts (your electric usage, line item costs, etc.).
* Aggregated datasets:
    * [Aggregations API]({{ "/specs/cds-wg3-01/latest" | relative_url }}#aggregations-api) - Standardizes how to document aggregated usage groups (whole-building usage, zip-code level usage, etc.).
* Customer usage data:
    * [Usage Segments API]({{ "/specs/cds-wg3-01/latest" | relative_url }}#usage-segments-api) - Standardizes how to provide usage data, both individual (e.g. kWh intervals) and aggregated (e.g. monthly whole-building usage).
* Energy Attribute Certificates:
    * [Energy Attribute Certificates API]({{ "/specs/cds-wg3-01/latest" | relative_url }}#eac-api) - Standardizes how to provide EACs from utilities and other central entities to Clients.
...
Next: [Read the specification (latest version)]({{ "/specs/cds-wg3-01/latest" | relative_url }})
